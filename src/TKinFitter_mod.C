...
TKinFitter_mod::TKinFitter_mod(const TString &name, const TString &title):
  TNamed(name, title),
  _A(1, 1),
  _AT(1, 1),
  _B(1, 1),
...
void TKinFitter_mod::resetStatus() {
...
void TKinFitter_mod::resetParams() {
...
void TKinFitter_mod::countMeasParams() {
...
void TKinFitter_mod::countUnmeasParams() {
...
void TKinFitter_mod::addMeasParticle( TAbsFitParticle* particle ) {
...
void TKinFitter_mod::addMeasParticles( TAbsFitParticle* p1, TAbsFitParticle* p2, TAbsFitParticle* p3, 
...
void TKinFitter_mod::addUnmeasParticle( TAbsFitParticle* particle ) {
...
void TKinFitter_mod::addUnmeasParticles( TAbsFitParticle* p1, TAbsFitParticle* p2, TAbsFitParticle* p3, 
				     TAbsFitParticle* p4, TAbsFitParticle* p5, TAbsFitParticle* p6,
				     TAbsFitParticle* p7, TAbsFitParticle* p8, TAbsFitParticle* p9) {
...
void TKinFitter_mod::addConstraint( TAbsFitConstraint* constraint ) {
  // add a constraint
...
void TKinFitter_mod::setVerbosity( Int_t verbosity ) { 
...
void TKinFitter_mod::fitMeasuredOnly() {
  Double_t prevF;
  Double_t currF = getF();
  Double_t prevS;
  Double_t currS = 0.;
...
void TKinFitter_mod::fitNeuPzOnly() {
...
void TKinFitter_mod::setCovMatrix( TMatrixD &V ) {
...
Bool_t TKinFitter_mod::calcC31(bool calcA) {
...
Bool_t TKinFitter_mod::calcC33(bool calcA) {
...
Bool_t TKinFitter_mod::calcC(bool calcA) {
...
Bool_t TKinFitter_mod::calcDeltaA() {
...
Bool_t TKinFitter_mod::calcDeltaY() {
...
Bool_t TKinFitter_mod::calcLambda() {
...
Bool_t TKinFitter_mod::calcVFit() {
...
Bool_t TKinFitter_mod::applyDeltaA() {
...
Bool_t TKinFitter_mod::applyDeltaY() {
...
Bool_t TKinFitter_mod::converged( Double_t F, Double_t prevS, Double_t currS ) {
...
Bool_t TKinFitter_mod::converged_F( Double_t F) {
  // check whether convergence criteria are fulfilled
  Bool_t isConverged = false;
...
Bool_t TKinFitter_mod::converged_S( Double_t prevS, Double_t currS ) {
  // check whether convergence criteria are fulfilled
  Bool_t isConverged = false;
...
TString TKinFitter_mod::getStatusString() {
...
void TKinFitter_mod::printMatrix(const TMatrixD &matrix, const TString& name) {
